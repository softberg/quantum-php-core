...
class RouteExceptionTest extends AppTestCase
{
    public function testCoreFactories(): void
    {
        ...
        $this->assertSame(E_ERROR, RouteException::incompleteControllerRoute()->getCode());
        $this->assertSame('Nested route groups are not supported', RouteException::nestedGroups()->getMessage());
        $this->assertSame(E_WARNING, RouteException::nestedGroups()->getCode());
        ...
        $this->assertSame(E_WARNING, RouteException::middlewaresOutsideRoute()->getCode());
    ...
    public function testParameterizedFactories(): void
    {
        ...
        $this->assertSame(E_ERROR, RouteException::moduleRoutesNotClosure('Blog')->getCode());
        $this->assertSame('Route name `home` must be unique within module', RouteException::nonUniqueNameInModule('home')->getMessage());
        $this->assertSame(E_WARNING, RouteException::nonUniqueNameInModule('home')->getCode());
        ...
        $this->assertSame(E_ERROR, RouteException::actionNotFound('index', 'PostController')->getCode());
        ...
        $this->assertSame(E_ERROR, RouteException::invalidHandlerResponse('handler', 'Quantum\\Http\\Response')->getCode());
        $this->assertSame('Route param name `id` already in use', RouteException::paramNameNotAvailable('id')->getMessage());
        $this->assertSame(E_WARNING, RouteException::paramNameNotAvailable('id')->getCode());
    }
}
