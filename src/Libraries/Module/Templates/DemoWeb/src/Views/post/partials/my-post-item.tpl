<li class="collection-item avatar">
    ...
    <a href="<?php echo base_url(true) . '/' . current_lang() . '/my-posts/amend/' . $post['uuid'] ?>?ref=my-posts" class="secondary-content edit-my-post" title="<?php _t('common.edit') ?>" style="right: 50px;">
